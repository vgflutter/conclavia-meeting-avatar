...
La release del 26 settembre include il kit `4d52bea`: corretta la compensazione che teneva ferma la testa, ripristinati i movimenti locali di guance, sopracciglia e fronte, e recuperato il labiale precedente meno esasperato. Voce invariata. Superati i quattro test browser dell’host fotografico e la build Linux coordinata con Onboarding. [Diagnosi e limiti visivi](https://github.com/vgflutter/conclavia-avatar-kit/blob/main/docs/host/motion-regression.md).
