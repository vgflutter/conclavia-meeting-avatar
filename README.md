...
La release del 26 settembre include il kit `bebd1a5`: espressione completa del volto, labbro superiore mobile e saluti IT/EN rigenerati con voce invariata. Superati i quattro test browser dell’host fotografico e la build Linux coordinata con Onboarding. [Procedura e limiti visivi](https://github.com/vgflutter/conclavia-avatar-kit/blob/main/docs/host/full-face-performance.md).
