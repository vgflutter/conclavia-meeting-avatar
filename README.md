...
La release del 26 settembre include il kit `1437512`: la pelle centrale e alta della fronte segue ora le sopracciglia con attivazione graduale. Il montaggio della bocca usa un contorno subpixel e un bordo inferiore stabile per tutta la frase, riducendo gli scatti di texture della barba. Voce e tempi invariati; rimangono una morbidezza delle labbra generate e un lieve bordo superiore chiaro in alcuni fonemi. Superati i quattro test browser dell’host fotografico e la build Linux coordinata con Onboarding. [Diagnosi e limiti visivi](https://github.com/vgflutter/conclavia-avatar-kit/blob/main/docs/host/motion-regression.md).
