...
See the [female/browser verification](female-avatar-verification-2026-09-11.md), [previous real-AI/provider checks](poc-audit-2026-09-10.md), [live Teams evidence](live-meeting-verification-2026-09-10.md), and [README objective matrix](guide.md#poc-objectives-and-acceptance). Passing local tests must not be presented as completion of this remaining acceptance gate.
