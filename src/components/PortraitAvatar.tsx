...
import portraits from "@/assets/avatar/portraits-2-5d-v1.png";
import features from "@/assets/avatar/portraits-2-5d-features-v1.png";
...
export function PortraitAvatar({ appearance = "business_clay", gesture = "rest", voiceLevel = 0,
  ...
  useEffect(() => {
    ...
    const images = [portraits, features].map(source => { const image = new window.Image(); image.src = source.src; return image; });
  ...
  return <div className={styles.portrait} data-design="portrait-2-5d" data-appearance={appearance}
    ...
    data-renderer={failed ? "fallback-2d" : "texture-rig"} data-asset={portraits.src} data-features-asset={features.src}
