...
$meetingMap = "/Game/Conclavia/Meeting/L_MeetingAvatar_v21"
$meetingMapFile = "C:\ConclaviaMeetingAvatar\Content\Conclavia\Meeting\L_MeetingAvatar_v21.umap"
...
$screenPercentage = if ($QualityPreset -eq "super") { 125 } else { 100 }
