...
$staging = 'C:\ConclaviaStudio\Saved\grade1-v3'
$archive = Join-Path $staging 'grade1-v3.zip'
...
if (-not (Select-String -Path $stagedBridge -SimpleMatch 'commercial-grade1-hero-56-v3' -Quiet)) {
...
Write-Output 'GRADE1_HERO_V3_BUILD_OK'
